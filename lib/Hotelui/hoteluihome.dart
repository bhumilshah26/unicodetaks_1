...
class HomePageUIState extends State<HomePageUI> {
  ...
  void fetchData() async {
    final Uri uri = Uri.https('worldwide-hotels.p.rapidapi.com', '/search');
    final Map<String, String> headers = {
      'content-type': 'application/x-www-form-urlencoded',
      'X-RapidAPI-Key': '10d1e0376cmsh40ae509163a8d45p1bd615jsn5df0ca6adf1c',
    ...
    if (response.statusCode == 200) {
      ...
      // Assuming the response has a 'data' field, you can extract it
      dynamic data = jsonResponse['results']['data'];

      // Assign the extracted data to a variable
      var res = data;

      // Now, you can use 'yourVariable' as needed
      print(res[1]);
    } else {
...
List<ListItem> items = [
  ListItem('The Royale', 'assets/hawaii1jpg.jpg',Colors.black,'Hawaii'),
